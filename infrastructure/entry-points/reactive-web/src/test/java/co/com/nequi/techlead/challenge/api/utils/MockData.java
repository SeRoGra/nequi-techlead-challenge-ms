...
public class MockData {
    ...
    public static List<Product> getFakeProducts(Site site) {
        return List.of(
                createFakeProduct(1, "Ice Cream", 20, site),
                createFakeProduct(2, "Milkshake", 40, site),
                createFakeProduct(3, "Ice & Waffles", 60, site)
        );
    }
}
