package co.com.nequi.techlead.challenge.jpa.helper;

import co.com.nequi.techlead.challenge.jpa.repository.BrandJPARepository;
import co.com.nequi.techlead.challenge.jpa.adapter.BrandAdapter;
...
class AdapterOperationsTest {
    ...
    void setUp() {
        ...
        adapter = new BrandAdapter(repository, objectMapper);
    }
